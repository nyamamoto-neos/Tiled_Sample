...
if platformName == "Android" then
	configFile = system.pathForFile( "extlib/tv/control_presets_android.json" )
elseif platformName == "Win" then
	configFile = system.pathForFile( "extlib/tv/control_presets_windows.json" )
elseif platformName == "Mac OS X" then
	configFile = system.pathForFile( "extlib/tv/control_presets_osx.json" )
elseif platformName == "iPhone OS" then
	configFile = system.pathForFile( "extlib/tv/control_presets_ios.json" )
elseif platformName == "tvOS" then
	configFile = system.pathForFile( "extlib/tv/control_presets_tvos.json" )
else
	print ("error platformName:"..platformName)
end
...
-- print(productName)
	...
	if ( not presetControls[productName] and string.find( productName, "Xbox One" ) and string.find( productName, "Microsoft" ) ) then
	...
	print("presetForDevice not found")
end
